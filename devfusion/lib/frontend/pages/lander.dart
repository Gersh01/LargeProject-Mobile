  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        home: Scaffold(
            ...
            body: Padding(
                padding: const EdgeInsets.only(left: 30.0, right: 30.0, top: 150.0, bottom: 5.0),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Button(placeholderText: "Get Started", backgroundColor: Colors.white, textColor: Colors.black,
                          onPressed: () {
